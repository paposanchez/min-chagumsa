...
// Route::group(['middleware' => ['auth:api']], function () {
  ...
  Route::group(['prefix' => 'garage'], function () {
      ...
      // 오늘부터 과거로
      Route::get('/diagnosises-complete/{대리점번호}/{page?}/{date?}/', "DiagnosisController@getDiagnosises")->name('diagnosises.complete');
      //개별주문조회
      ...
      Route::resource('/notice', "NoriceController", ['only' => ['index', 'show']]);
