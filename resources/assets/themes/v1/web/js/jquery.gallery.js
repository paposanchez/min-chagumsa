	...
	$.Gallery.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translateX(-400px) translateZ(-200px) rotateY(0deg)',
					'-moz-transform'	: 'translateX(-400px) translateZ(-200px) rotateY(0deg)',
					'-o-transform'		: 'translateX(-400px) translateZ(-200px) rotateY(0deg)',
					'-ms-transform'		: 'translateX(-400px) translateZ(-200px) rotateY(0deg)',
					'transform'			: 'translateX(-400px) translateZ(-200px) rotateY(0deg)'
				};
		...
		_navigate			: function( dir ) {
			...
			this.isAnim	= true;
			$('.dg-desc').find('div').eq(this.$currentItm.index()).fadeOut(400);
			//alert(this.$rightItm.index());
			...
			switch( dir ) {
				...
				case 'next' :
					...
					$('.dg-desc').find('div').eq(this.$rightItm.index()).fadeIn(600);
					break;
				...
				case 'prev' :
					...
					$('.dg-desc').find('div').eq(this.$leftItm.index()).fadeIn(600);
					break;	
