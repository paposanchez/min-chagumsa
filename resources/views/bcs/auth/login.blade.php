    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="tile tile-transparent shadow" style="margin-top:25%;">
                    ...
                    <div class="tile-row">
                        <div class="tile-col text-center">
                            <h3 class="text-muted">차검사 BCS Admin</h3>
                        ...
                        <div class="tile-col">
                            ...
                            <div class="form-group  {{ $errors->has('email') ? 'has-error' : '' }}">
                                <label for="inputEmail"
                                       class="control-label sr-only">{{ trans('web/register.email') }}</label>
                            ...
                            <div class="form-group  {{ $errors->has('password') ? 'has-error' : '' }}">
                                <label for="inputPassword"
                                       class="control-label sr-only">{{ trans('web/register.password') }}</label>
                                <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <button class="btn btn-block btn-primary" data-loading-text="처리중..." type="submit">
                                        로그인
                                    </button>
                                </div>
                            </div>
                ...
                <p class="text-center">
                    <small class="text-muted text-light">Copyrights by <a target="_blank"
                                                                          href="http://www.chagumsa.com">www.chagumsa.com</a>
