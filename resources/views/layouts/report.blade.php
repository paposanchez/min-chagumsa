...
<div id='document'>
    ...
    <div id='report_wrap'>
        ...
        <div class='report_left'>
            ...
            <ul>
                <li><a class='{{ $page == "summary" ? "select" : '' }}'
                       href="{{ $url_prefix }}/{{ $order_id }}/summary">자동차 요약 보고서</a></li>
                <li><a class='{{ $page == "performance" ? "select" : '' }}'
                       href="{{ $url_prefix }}/{{ $order_id }}/performance">자동차 품질 보고서</a></li>
                <li><a class='{{ $page == "price" ? "select" : '' }}' href="{{ $url_prefix }}/{{ $order_id }}/price">자동차
                        가격 산정 보고서</a></li>
                <li><a class='{{ $page == "history" ? "select" : '' }}'
                       href="{{ $url_prefix }}/{{ $order_id }}/history">자동차 이력 보고서</a></li>
            </ul>
            <p>
                ...
                @if(!$order->isIssued())
                    <div class="breadcrumb">
                        <div class="panel-body">
                            <p class="text-primary " style="font-size: 30px;font-style: italic;font-weight: bold"><i
                                        class="fa fa-chevron-circle-right" aria-hidden="true"></i> 미리보기</p>
                        </div>
                    </div>
                @endif
