                                        ...
                                        <thead>
                                                <tr class="">
                                                        <th class="text-center"><a class="sort" href="#" id="status"><i
                                                                ...
                                                                <th class="text-center"><a class="sort" href="#" id="expired_at"><i class="zmdi zmdi-unfold-more" aria-hidden="true"></i> 만료일</a></th>
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="text-center">
                                                                        ...
                                                                        <a href="{{ route("diagnosis.show", [$data->id]) }}" class="btn btn-default btn-icon waves-effect waves-float" data-toggle="tooltip" title="진단정보 상세보기"><i class="zmdi zmdi-search-in-page"></i></a>

                                                                        <a href="{{ route("review.show", [$data->id]) }}" class="btn btn-default btn-icon waves-effect waves-float" data-toggle="tooltip" title="진단정보 검토하기"><i class="zmdi zmdi-assignment-check"></i></a>

                                                                        @if( !in_array($data->status_cd, [115, 120]))
                                                                        <a href="{{ url("diagnosis", [$data->id]) }}" class="btn btn-default btn-icon waves-effect waves-float" data-toggle="tooltip" title="예약관리"><i class="zmdi zmdi-calendar-check"></i></a>
                                                                        @endif
