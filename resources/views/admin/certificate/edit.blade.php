                    ...
                    <ul class="actions">
                        ...
                        <li>
                            <a href="{{ url("diagnosis", [$certificate->diagnosis_id]) }}" target="_blank"
                               class="btn btn-default" data-toggle="tooltip" title="인증서 진단정보 보기">진단정보 보기</a>
                        </li>

                        @if($certificate->status_cd == 114)
                            <li>
                                <button id="issue" class="btn btn-primary" data-toggle="tooltip" title="인증서 진단정보 보기"
                        ...
                        @if(!in_array($certificate->status_cd, ['115', '116', '120']))
                            <li>
                                <button id="certificate-submit" class="btn btn-info" data-toggle="tooltip"
                                        title="인증서 저장하기">저장
                                </button>
                            </li>
                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <div class="input-group">
                                            <div class="fg-line">
                                                <input type="text"
                                                       class="form-control text-right cert-calculate-subtotal"
