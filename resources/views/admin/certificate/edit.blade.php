        ...
        <div class="container">
            <div class="card">
                <div class="card-header ch-alt">
                    <h2>
                        <span class="text-danger text-lighter">{{ $certificate->status->display() }}</span> {{ $certificate->chakey }}
                        <small>번호 : <span class="text-info">{{ $certificate->id }}</span> / 최초생성일 : <span
                                    class="text-info">{{ $certificate->created_at }}</span> / 최종수정일 : <span
                                    class="text-info">{{ $certificate->updated_at or '-' }}</span></small>
                    </h2>
                    ...
                    <ul class="actions">
                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->hasRole('admin'))
                            <li>
                                <button class="btn btn-default pull-right link"
                                        data-url="/order/{{ $certificate->order->id }}">주문보기
                                </button>
                            </li>
                        @endif
                        ...
                        <li>
                            <button class="btn btn-default pull-right link"
                                    data-url="/diagnosis/{{ $certificate->diagnosis_id }}" data-toggle="tooltip"
                                    title="인증서 진단정보 보기">진단정보 보기
                            </button>
                        </li>

                        @if($certificate->status_cd == 114)
                            <li>
                                <button id="issue" class="btn btn-primary pull-right" data-toggle="tooltip"
                                        title="인증서 진단정보 보기"
                                        data-id="{{ $certificate->id }}">발급
                                </button>
                            </li>
                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 col-sm-offset-4">
                                            <div class="input-group">
                                                <div class="fg-line">
                                                    <input type="text"
                                                           class="form-control cert-calculate-subtotal"
                                                           placeholder="" title="" name="certificates_new_car_price"
                                                           id="new_car_price" value="{{ $certificate->new_car_price }}">
                                                </div>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-cost"
                                                           placeholder=""
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-sm-offset-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-subtotal"
                                                           placeholder=""
                                                           title="" name="history_depreciation"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-cost"
                                                           ...
                                                           value="{{ $certificate->usage_mileage_depreciation }}"
                                                           required>
                                                    <span class="input-group-addon">만원</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-cost"
                                                           ...
                                                           value="{{ $certificate->usage_history_depreciation }}"
                                                           required>
                                                    <span class="input-group-addon">만원</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-sm-offset-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-subtotal"
                                                           placeholder=""
                                                           title="" name="performance_depreciation"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-sm-offset-7">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-subtotal"
                                                           placeholder=""
                                                           title="" name="special_depreciation"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" id="certificates_history_purpose"
                                                       class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                           name="certificates_history_owner"
                                                           id="certificates_history_owner"
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3 col-sm-offset-7 text-right">
                                                <div class="input-group">
                                                    <input type="text" class="form-control cert-calculate-subtotal"
                                                           placeholder="P ± A ± B ± S" title=""
                                                           name="certificates_valuation"
                                                           id="valuation" value="{{ $certificate->valuation }}"
                                                           required>
                                                    <span class="input-group-addon">만원</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="block bg-white" style="margin-bottom:10px;">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item no-border"><span>주문자명</span> <em
                                                        class="pull-right">{{ $certificate->order->orderer_name }}</em>
                                            </li>
                                            <li class="list-group-item no-border"><span>주문자연락처</span> <em
                                                        class="pull-right">{{ $certificate->order->orderer_mobile }}</em>
                                            </li>
                                            <li class="list-group-item no-border"><span>상품명</span> <em
                                                        class="pull-right">{{ $certificate->orderItem->item->name }}</em>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="block bg-white" style="margin-bottom:10px;">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item no-border"><span>차량명</span> <em
                                                        class="pull-right">{{ $certificate->carNumber->car->getFullName()  }}</em>
                                            </li>
