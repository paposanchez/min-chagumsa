        ...
        <div class="col-md-12">
            ...
            <fieldset>
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="{{ trans('admin/role.name') }}" disabled="true" id="inputName" value="{{ $role->name or old('name') }}">
                ...
                <div class="form-group {{ $errors->has('display_name') ? 'has-error' : '' }}">
                    <label for="inputDisplayName" class="control-label col-md-3">{{ trans('admin/role.display_name') }}</label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="{{ trans('admin/role.display_name') }}" name="display_name" id="inputDisplayName" value="{{ $role->display_name or old('display_name') }}">
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    <label for="inputdescription" class="control-label col-md-3">{{ trans('admin/role.description') }}</label>
                    <div class="col-md-6">
                        <textarea rows="5" class="form-control" placeholder="{{ trans('admin/role.description') }}" name="description" id="inputdescription">{{ $role->description or old('description') }}</textarea>
                ...
                <div class="form-group {{ $errors->has('permission') ? 'has-error' : '' }}">
                    <label for="inputPermission" class="control-label col-md-3">{{ trans('admin/role.permission') }}</label>
                    <div class="col-md-6">
