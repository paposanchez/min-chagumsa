        ...
        <div class="list-group">
            <a class="list-group-item media" href="">
                <div class="pull-left p-relative">
                    <img class="lgi-img" src="/assets/img/demo/profile-pics/2.jpg" alt="">
            ...
            <a class="list-group-item media" href="">
                <div class="pull-left p-relative">
                    <img class="lgi-img" src="/assets/img/demo/profile-pics/3.jpg" alt="">
            ...
            <a class="list-group-item media" href="">
                <div class="pull-left p-relative">
                    <img class="lgi-img" src="/assets/img/demo/profile-pics/4.jpg" alt="">
                    <i class="chat-status-online"></i>
                </div>
                <div class="media-body">
            ...
            <a class="list-group-item media" href="">
                <div class="pull-left">
                    <img class="lgi-img" src="/assets/img/demo/profile-pics/5.jpg" alt="">
                </div>
                <div class="media-body">
            ...
            <a class="list-group-item media" href="">
                <div class="pull-left">
                    <img class="lgi-img" src="/assets/img/demo/profile-pics/6.jpg" alt="">
                </div>
                <div class="media-body">
