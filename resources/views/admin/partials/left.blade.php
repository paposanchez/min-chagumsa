<aside id="sidebar" class="sidebar c-overflow">
        ...
        <ul class="main-menu">
                ...
                <li class="{{ Request::is('diagnosis*') ? ' active':''}}"><a href="{{ route('diagnosis.index') }}"><i
                        class="zmdi zmdi-assignment-check"></i> 진단관리</a></li>

                                <li class="{{ Request::is('certificate*') ? ' active':''}}"><a href="{{ route('certificate.index') }}"><i
                                        class="zmdi zmdi-assignment-alert"></i> 인증관리</a></li>

                                        <li class="{{ Request::is('warranty*') ? ' active':''}}"><a href="{{ route('warranty.index') }}"><i
                                                class="zmdi zmdi-assignment"></i> 보증관리</a></li>

                                                <li class="{{ Request::is('purchase*') ? ' active':''}}"><a href="{{ route('purchase.index') }}"><i
                                                        class="zmdi zmdi-card"></i> 결제관리</a></li>


                                                        <li class="sub-menu {{ Request::is('calculation*') ? ' active':''}}">
                                                                <a href="" data-ma-action="submenu-toggle"><i class="zmdi zmdi-money-box"></i> 정산관리</a>
                                                                <ul>
                                                                        <li><a href="{{ route('calculation.index') }}">정산목록</a></li>
                                                                        <li><a href="{{ route('calculation.bcs') }}">Bcs</a></li>
                                                                        <li><a href="{{ route('calculation.tech') }}">Tech</a></li>
                                                                        <li><a href="{{ route('calculation.alliance') }}">Alliance</a></li>
                                                                        <li><a href="{{ route('calculation.insurer') }}">Insurer</a></li>
                                                        ...
                                                        @if(\Illuminate\Support\Facades\Auth::user()->can('post.show'))
                                                        <li class="sub-menu {{ Request::is('post/posting*') ? ' active':''}}">
                                                        ...
                                                        <li class="{{ Request::is('sms*') ? ' active':''}}"><a href="{{ route('sms.index') }}"><i
                                                                ...
                                                                <li class="sub-menu {{ Request::is('config*') ? ' active':''}}">
                                                                        ...
                                                                        <ul>
                                                                                ...
                                                                                <li class="{{ Request::is('config/code*') ? ' active':''}}"><a href="{{ route('code.index') }}">코드관리</a>
                                                                                </li>
                                                                                <li class="{{ Request::is('config/item*') ? ' active':''}}"><a href="{{ route('item.index') }}">상품관리</a>
                                                                                </li>
