            ...
            <fieldset>
                ...
                <div class="form-group {{ $errors->has('use_secret') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_secret" {{ $board->use_secret == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_comment') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_comment" {{ $board->use_comment == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_opinion') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_opinion" {{ $board->use_opinion == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_tag') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_tag" {{ $board->use_tag == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_category') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_category" {{ $board->use_category == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_upload') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_upload" {{ $board->use_upload == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_thumbnail') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1" name="use_thumbnail" {{ $board->use_thumbnail == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('upload_max_filesize') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="{{ trans('admin/board.upload_max_filesize') }}" name="upload_max_filesize" id="inputUploadMaxFilesize" value="{{ $board->upload_max_filesize or old('upload_max_filesize') }}">
                ...
                <div class="form-group {{ $errors->has('upload_max_limit') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" placeholder="{{ trans('admin/board.upload_max_limit') }}" name="upload_max_limit" id="inputUploadMaxLimit" value="{{ $board->upload_max_limit or old('upload_max_limit') }}">                        
