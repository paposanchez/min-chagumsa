                        ...
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_secret" {{ old('use_secret') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_captcha') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_captcha" {{ old('use_captcha') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_comment') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_comment" {{ old('use_comment') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_opinion') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_opinion" {{ old('use_opinion') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_tag') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_tag" {{ old('use_tag') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_category') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_category" {{ old('use_category') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_upload') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_upload" {{ old('use_upload') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
                ...
                <div class="form-group {{ $errors->has('use_thumbnail') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <div class="checkbox checkbox-slider--b-flat">
                            <label>
                                <input type="checkbox" value="1"
                                       name="use_thumbnail" {{ old('use_thumbnail') == 1 ? 'checked="checked"' : '' }}><span></span>
                            </label>
                        </div>
