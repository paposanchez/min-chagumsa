    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                <label for="inputContent" class="control-label col-md-3">{{ trans('admin/comment.content') }}</label>
                <div class="col-md-9">
                    <textarea  class="form-control wysiwyg" placeholder="{{ trans('admin/comment.content') }}" name="content" id="inputContent">
                        {{ old('content') }}
                    </textarea>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="{{ trans('admin/comment.name') }}" name="name" id="inputName" value="{{ old('name') }}">
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <input type="email" class="form-control" placeholder="{{ trans('admin/comment.email') }}" name="email" id="inputEmail" value="{{ old('email') }}">
            ...
            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                <label for="inputPassword" class="control-label col-md-3">{{ trans('admin/comment.password') }}</label>
                <div class="col-md-4">
                    <input type="password" class="form-control" placeholder="{{ trans('admin/comment.password') }}" name="password" id="inputPassword">
