        ...
        <div class="col-md-12">
            ...
            <fieldset>
                <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                    <label for="inputSubject" class="control-label col-md-3">{{ trans('admin/posts.subject') }}</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="{{ trans('admin/posts.subject') }}" name="subject" id="inputSubject" value="{{ $post->subject or old('subject') }}">
                ...
                <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                    <label for="inputContent" class="control-label col-md-3">{{ trans('admin/posts.content') }}</label>
                    <div class="col-md-9">
                        <textarea  class="form-control wysiwyg" placeholder="{{ trans('admin/posts.content') }}" name="content" id="inputContent">
                ...
                <div class="form-group {{ $errors->has('board_id') ? 'has-error' : '' }}">
                    <label for="inputBoardId" class="control-label col-md-3">{{ trans('admin/posts.board_id') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group {{ $errors->has('user_id') ? 'has-error' : '' }}">
                    <label for="inputUserId" class="control-label col-md-3">{{ trans('admin/posts.user_id') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" placeholder="{{ trans('admin/posts.name') }}" name="name" id="inputName" value="{{ $post->name or old('name') }}">
                ...
                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-4">
                        <input type="email" class="form-control" placeholder="{{ trans('admin/posts.email') }}" name="email" id="inputEmail" value="{{ $post->email or old('email') }}">
                ...
                <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                    <label for="inputPassword" class="control-label col-md-3">{{ trans('admin/posts.password') }}</label>
                    <div class="col-md-4">
                        <input type="password" class="form-control" placeholder="{{ trans('admin/posts.password') }}" name="password" id="inputPassword">
