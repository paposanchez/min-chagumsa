...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            {!! Form::open(['method' => 'POST','route' => ['bcs-post.store'], 'class'=>'form-horizontal', 'id'=>'frmPost', 'enctype'=>"multipart/form-data"]) !!}

            <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                <label for="inputSubject" class="control-label col-md-3">{{ trans('admin/bcs-post.subject') }}</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="{{ trans('admin/bcs-post.subject') }}" name="subject" id="inputSubject" value="{{ old('subject') }}">
            ...
            <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                ...
                <div class="col-md-9">
                    <textarea  class="form-control" placeholder="{{ trans('admin/bcs-post.content') }}" name="content" id="inputContent" style="height:250px;"></textarea>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="{{ trans('admin/bcs-post.name') }}" name="name" id="inputName" value="{{ \Illuminate\Support\Facades\Auth::user()->name }}">
