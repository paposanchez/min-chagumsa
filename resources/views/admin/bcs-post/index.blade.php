...
@section('breadcrumbs')
@include('/vendor/breadcrumbs/wide', ['breadcrumbs' => Breadcrumbs::generate('admin.bcs-post')])
@endsection
...
<div class="container-fluid">
            ...
            <table class="table text-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            @if($data->user_id)
                            <a href="{{ route("bcs-post.index", ['user_id'=> $data->user_id]) }}">
                                @endif
                                {{ $data->name or '-' }}
                                @if($data->user_id)
                            </a>
                        ...
                        <td>
                            <a href="{{ route('bcs-post.edit', $data->id) }}" class="btn btn-default"  data-tooltip="{pos:'top'}" title="수정">수정</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <a href="{{ route('bcs-post.create') }}" class="btn btn-primary">등록</a>
