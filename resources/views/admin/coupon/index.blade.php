...
<div class="container-fluid">
            ...
            <table class="table text-middle text-center">
                ...
                <tbody>
                    ...
                    @unless(count($entrys)>0)
                        <tr><td colspan="7" class="no-result"><p class="text-center">발행된 쿠폰이 없습니다.</p></td></tr>
                    @endunless
                    ...
                    <tr>
                        ...
                        <td class="">{{ $data->coupon_number }}</td>
    ...
    {{-- 사용자정보 modal --}}
    <div class="modal fade bs-example-modal-lg in order-modal" id="user-modal" tabindex="-1" role="dialog" aria-labelledby="order-modal" aria-hidden="true">
