    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group {{ $errors->has('publish_num') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="" class="form-control" placeholder="쿠폰방행 부수를 입력해 주세요." name="publish_num" id="publish_num" required>
            ...
            <div class="form-group {{ $errors->has('coupon_kind') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="쿠폰종류 입력" name="coupon_kind" id="coupon_kind" value="promotion" required readonly>
            ...
            <div class="form-group {{ $errors->has('publish_length') ? 'has-error' : '' }}">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" placeholder="쿠폰코드 길이수를 입력해주세요.(기본 10, 최대 20)" name="publish_length" id="publish_length" required="required">
