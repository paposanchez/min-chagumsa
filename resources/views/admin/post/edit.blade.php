                ...
                <fieldset>
                    ...
                    <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                        ...
                        @if($post->board->use_tag)
                                wysiwyg
@endif
                                " placeholder="{{ trans('admin/post.content') }}" name="content" id="inputContent"
                    ...
                    <div class="form-group {{ $errors->has('answer') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control wysiwyg" placeholder=""
                                      name="answer" id="inputAnswer"
                    ...
                    <div class="form-group {{ $errors->has('is_answered') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="checkbox checkbox-slider--b-flat">
                                <label>
                                    <input type="checkbox" value="1" name="is_answered" {{ $post->is_answered == 1 ? 'checked="checked"' : '' }}><span></span>
                                </label>
                            </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker" data-format="YYYY-MM-DD HH:II:SS"
