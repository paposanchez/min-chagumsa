...
<div class="row">
        ...
        <div class="col-md-offset-3 col-md-9">
                ...
                <button class="btn btn-success" data-loading-text="{{ trans('common.button.loading') }}">주문생성</button>

                <button class="btn btn-default btn-back" data-loading-text="{{ trans('common.button.loading') }}">취소</button>
