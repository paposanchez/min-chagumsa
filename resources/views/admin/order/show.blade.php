    ...
    <div class="container-fluid">
        ...
        <h3>
            ...
            @if($order->status_cd > 106)
                <a href="{{ url("diagnosis", [$order->id]) }}" class="btn btn-danger pull-right"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group  form-group-lg {{ $errors->has('garages') ? 'has-error' : '' }}"
                                ...
                                <select class="form-control" id="garages" name="garages" autocomplete="off">
                                    <option value="0">대리점을 선택하세요.</option>
                                </select>
        ...
        <div id="techModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group  form-group-lg  {{ $errors->has('technician') ? 'has-error' : '' }}"
                             style="margin:0px;">
