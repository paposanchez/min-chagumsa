        ...
        <div class="container">
                ...
                <div class="card">
                        ...
                        <div class="card-header ch-alt">
                                <h2>주문관리
                                        <small>총 <strong class="text-primary">{{ number_format($entrys->total()) }}</strong>개의 검색결과가 있습니다.</small>
                                </h2>
                        </div>
                                                ...
                                                <div role="tabpanel" class="tab-pane animated fadeIn m-t-20" id="tab-2">
                                                        <form method="GET" class="form-horizontal" role="form" id="searchFormCollapse">
                                                                ...
                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                                <input type="text" class="form-control input-mask date-picker" name='trs' value='{{ $trs }}' data-mask="0000-00-00" placeholder="시작일" autocomplete="off" maxlength="10">
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                                <input type="text" class="form-control input-mask date-picker" name='tre' value='{{ $tre }}' data-mask="0000-00-00" placeholder="종료일" autocomplete="off" maxlength="10">
                                                                        </div>
                                                                </div>
