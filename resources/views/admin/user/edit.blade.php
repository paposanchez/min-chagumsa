        ...
        <div class="container">
                <div class="card">
                        ...
                        <div class="card-header ch-alt">
                                <h2>회원정보 수정
                                        <small>최초생성일 : <span class="text-info">{{ $user->created_at }}</span> / 최종수정일 : <span class="text-info">{{ $user->updated_at or '-' }}</span></small>
                                </h2>
                        </div>
                        ...
                        <div class="card-body card-padding">
                                ...
                                <fieldset>
                                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.email') }}</label>
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                        <input type="name" class="form-control" placeholder="{{ trans('admin/user.name') }}"
                                        ...
                                        <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.new-password') }}</label>
                                                <div class="col-md-4">
                                                        <input type="password" class="form-control"
                                                        placeholder="{{ trans('admin/user.new-password') }}" name="password"
                                                        id="inputPassword">
                                        ...
                                        <div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.new-password_confirmation') }}</label>
                                                <div class="col-md-4">
                                                        <input type="password" class="form-control"
                                                        placeholder="{{ trans('admin/user.new-password_confirmation') }}"
                                        ...
                                        <div class="form-group {{ $errors->has('roles') ? 'has-error' : 'roles' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.roles') }}</label>
                                        ...
                                        <div class="form-group {{ $errors->has('garage') ? 'has-error' : 'garage' }} "
                                                style="display: none;">
                                                <label for="inputGarage"
                                                class="control-label col-md-3">{{ trans('admin/user.garage') }}</label>
                                                <div class="col-md-6 selected_garage">
                                                        @if($user->user_extra)
                                                        <input type="text" class="form-control" name="garage" id="selected_garage"
                                                        value="{{ $user->user_extra->garage ? $user->user_extra->garage->name : '' }}"
                                                        readonly>
                                                        @endif
                                        ...
                                        <div id="garage_info" style="display: none">
                                                ...
                                                <div class="form-group {{ $errors->has('garage_name') ? 'has-error' : '' }} garage_name">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                ...
                                                                placeholder="{{ trans('admin/user.garage_name') }}" name="garage_name"
                                                                id="garage_name"
                                                                value="{{ $user->user_extra ? $user->user_extra->ceo_name : '' }}">
                                                        </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('garage_tel') ? 'has-error' : '' }} garage_tel">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                <input type="text" class="form-control"
                                                                placeholder="{{ trans('admin/user.garage_tel') }}" name="garage_tel"
                                                                id="garage_tel"
                                                                value="{{ $user->user_extra ? $user->user_extra->phone : '' }}">
                                                        </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('fax') ? 'has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-4">
                                                                <input type="text" class="form-control"
                                                                placeholder="{{ trans('bcs/bcs-info.fax') }}"
                                                                name="fax" id="fax"
                                                                value="{{ $user->user_extra ? $user->user_extra->fax : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('garage_zipcode') ? 'has-error' : '' }} garage_zipcode">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                ...
                                                                id="garage_zipcode"
                                                                value="{{ $user->user_extra ? $user->user_extra->zipcode : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('garage_area') ? 'has-error' : '' }} garage_area">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                <input type="text" class="form-control"
                                                                placeholder="{{ trans('admin/user.garage_area') }}" name="garage_area"
                                                                id="garage_area"
                                                                value="{{ $user->user_extra ? $user->user_extra->area : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('garage_name') ? 'has-error' : '' }} garage_section">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                ...
                                                                id="garage_section"
                                                                value="{{ $user->user_extra ? $user->user_extra->section : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('garage_address') ? 'has-error' : '' }} garage_address">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                ...
                                                                id="garage_address"
                                                                value="{{ $user->user_extra ? $user->user_extra->address_extra : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('registration_number') ? 'has-error' : '' }} registration_number">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                ...
                                                                value="{{ $user->user_extra ? $user->user_extra->registration_number : '' }}">
                                                        </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('bank') ? 'has-error' : '' }} bank">
                                                        <label for="inputGarage"
                                                        class="control-label col-md-3">{{ trans('admin/user.bank') }}</label>
                                                        <div class="col-md-6 ">
                                                                <input type="text" class="form-control" placeholder="{{ trans('admin/user.bank') }}"
                                                                name="bank" id="bank"
                                                                value="{{ $user->user_extra ? $user->user_extra->bcs_bank : '' }}">
                                                ...
                                                <div class="form-group {{ $errors->has('account') ? 'has-error' : '' }} account">
                                                        ...
                                                        <div class="col-md-6 ">
                                                                <input type="text" class="form-control"
                                                                placeholder="{{ trans('admin/user.account') }}"
                                                                name="account" id="account"
                                                                value="{{ $user->user_extra ? $user->user_extra->bcs_account : '' }}">
                                                                <span class="help-block">{{ trans('admin/user.help-account') }}</span>
                                                        </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('owner') ? 'has-error' : '' }} bank">
                                                        <label for="inputGarage"
                                                        class="control-label col-md-3">{{ trans('admin/user.owner') }}</label>
                                                        <div class="col-md-6 ">
                                                                <input type="text" class="form-control"
                                                                placeholder="{{ trans('admin/user.owner') }}"
                                                                name="owner" id="owner"
                                                                value="{{ $user->user_extra ? $user->user_extra->bcs_account_name : '' }}">
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.mobile') }}</label>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group {{ $errors->has('status_cd') ? 'has-error' : '' }}">
                                                ...
                                                class="control-label col-md-3">{{ trans('admin/user.status') }}</label>
                                                <div class="col-md-9">
                                                        <div class="btn-group" data-toggle="buttons">
                                                                ...
                                                                <label class="btn btn-default {{ $user->status_cd == $code->id ? 'active' : '' }}">
                                                                        ...
                                                                        {{ $user->status_cd == $code->id ? 'checked' : '' }} value="{{ $code->id }}"> {{ $code->display() }}
                                                                </label>
                                                                @endforeach
                                                        </div>
                                        ...
                                        <div class="form-group">
                                                <div class="col-md-6 col-md-offset-3">
                                                        ...
                                                        <!-- 최고관리자 -->
                                                        @if ($user->id != 1)
                                                        <button class="btn btn-danger pull-right" id="btn-user-destory" type="button" data-loading-text="{{ trans('common.button.loading') }}">{{ trans('common.button.destroy') }}</button>
                                                        @endif
...
id="garage_imgs-template">@include("partials/files", ['files'=> $user->user_extra->bcsimg_files])</script>
<script type="text/template"
