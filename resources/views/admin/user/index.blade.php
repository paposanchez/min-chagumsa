                                                ...
                                                <tr class="active">
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td>
                                                                                <span class="label label-info">{!! $data->roles->implode('display_name', '</span> <span class="label label-info">') !!}</span>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                                <a href="{{ route("user.edit", [$data->id]) }}" class="btn btn-default btn-icon waves-effect waves-float" data-toggle="tooltip" title="수정하기"><i class="zmdi zmdi-search-in-page"></i></a>
                                                                        </td>
