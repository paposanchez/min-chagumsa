...
@section( 'content' )
                    ...
                    <fieldset>
                        ...
                        {{--<div class="form-group {{ $errors->has('role') ? 'has-error' : '' }}">--}}
                            ...
                            {{--<div class="col-md-6">--}}
                                ...
                                {{--{!! Form::select('role[]', $roles->pluck("name","id"), $rolePermissions, ['class'=>'form-control', 'multiple', 'id'=>'role-permission']) !!}--}}
    ...
    {!! Form::open(['method' => 'DELETE', 'route' => ['permission.destroy', $permission->id], 'id'=>'frm-role-destroy']) !!}
    {!! Form::close() !!}
@endsection
