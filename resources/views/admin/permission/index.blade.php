...
<div class="container-fluid">
            ...
            <table class="table text-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('permission.edit', $data->id) }}" class="btn btn-default"  data-tooltip="{pos:'top'}" title="{{ trans('common.button.edit') }}">{{ trans('common.button.edit') }}</a>
                        </td>                        
                    </tr>
                    @endforeach
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <a href="{{ route('permission.create') }}" class="btn btn-primary">{{ trans('common.button.create') }}</a>
