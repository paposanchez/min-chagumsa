...
@section( 'content-footer-script' )
        ...
        {!! Html::script('/assets/vendors/bower_components/flot/jquery.flot.pie.js', array(), true) !!}
        ...
        {!! Html::script('/assets/vendors/bootstrap-wizard/jquery.bootstrap.wizard.min.js', array(), true) !!}
