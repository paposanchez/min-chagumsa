                            ...
                            <table class="table text-center">
                                ...
                                @foreach($entrys as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning" data-toggle="tooltip" title="상세목록">상세목록
                                            </button>
                                            <button class="btn btn-warning" data-toggle="tooltip" title="정산취소">취소
                                            </button>
                                            <button class="btn btn-warning" data-toggle="tooltip" title="정산완료">완료
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
