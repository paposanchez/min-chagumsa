    ...
    <div id="sub_full_wrap">
        <div class="login_box_wrap" style="padding:20px;">
            ...
            <div class="form-group  {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <div class=" col-xs-9">
                    <input type="text" class="form-control  input-lg" placeholder="{{ trans('web/register.name') }}"
            ...
            <p class="text-center">
                <button class="btn btn-lg btn-block btn-success btns_green" data-loading-text="처리중..." type="submit">
                    가입하기
                </button>
            </p>
            {!! Form::close() !!}
