            ...
            <div class="tile tile-transparent shadow" style="margin-top:25%;">
                ...
                <div class="tile-row">
                    <div class="tile-col text-center">
                        ...
                        <p class="text-muted">Perfectly designed and precisely prepared admin theme with over 50 pages with extra new web app views.</p>
                    ...
                    <div class="tile-col">
                        ...
                        <form class="form-horizontal" role="form" method="POST"  action="{{ url('/login') }}">
                            ...
                            <div class="form-group  {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <div class="col-lg-12">
                                    <input type="email" class="form-control" placeholder="이메일" name="email" id="inputEmail">
