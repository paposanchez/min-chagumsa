                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control input-lg" placeholder='주문자 이름'
                                           value="{{ $user->name }}" name="orderer_name" id="orderer_name">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <span class="input-group-btn">
                                                                        <button class="btn btn-primary  btn-outline"
                                                                                type="button" id="mobile-verification">인증번호 전송</button>
                                                                </span>
                                </div>
                            </div>
                        </div>
        ...
        <div class="pt-page pt-page-2">
            ...
            <fieldset id="order-info-order">
                ...
                <p class="form-control-static text-center">
                    ...
                    <button type="button" class='btn btn-primary btn-lg wid25 order-page-move' data-index="2">다음
                    </button>
                </p>
            </fieldset>
        </div>
            ...
            <fieldset id="order-info-purchase">
                ...
                <div class="form-group">
                    ...
                    <div class="block" id="purchase-items">
                        ...
                        <div id="purchase-items-blind" style="z-index: 1">차량모델에 따라 상품이 자동선택됩니다. 상품을 변경하시려면 차량모델을
                            변경하세요.
                        </div>
                ...
                <p class="form-control-static text-center">
                    <button type="button" class='btn btn-default btn-lg wid25 order-page-back' data-index="1">이전
                    </button>
                    <button type="button" class='btn btn-primary btn-lg wid25 bmd-modalButton' id="payment-process">결제
                    </button>
                </p>
            </fieldset>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin:50px 0px;">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-xs-offset-3">
                            <button type="button" class='btn btn-primary btn-block btn-lg' id="modalSms-verify"><i
                                        class=" fa fa-check"></i> 인증
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lg" id="coupon_number"
                                   placeholder='쿠폰번호를 입력해 주세요.' name="coupon_number">
