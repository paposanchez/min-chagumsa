...
<div id='sub_wrap'>
        ...
        {!! Form::open(['route' => [$board_namespace.".update", $data->id], 'class' => 'form-horizontal', 'method' => 'patch', 'role' => 'form', 'id' => 'form']) !!}
        ...
        <div class="form-group form-group-lg {{ $errors->has('subject') ? 'has-error' : '' }}">
                ...
                <input type="text" class="form-control " placeholder="제목을 입력하세요" name="subject" id="inputSubject" value="{{ $data->subject }}">
        ...
        <div class="form-group form-group-lg {{ $errors->has('content') ? 'has-error' : '' }}">
                ...
                <textarea class='form-control' name="content" rows="12" placeholder='내용을 입력하세요'>{{ $data->content }}</textarea>
