...
@section( 'content' )
    <div id='sub_title_wrap'>
        <h2>인증서 조회
            <div class='sub_title_shortCut'>Home <i class="fa fa-angle-right"></i> <span>인증서 조회</span></div>
        </h2>
    </div>
    ...
    <div id='sub_wrap'>
        ...
        @unless(count($orders))
            <h3>{{ Html::image(Helper::theme_web( '/img/sub/cert_icon.png')) }}
                <div class='br20'></div>
                입력하신 인증서번호 또는 차량번호가 정확하지 않습니다.
            </h3>
