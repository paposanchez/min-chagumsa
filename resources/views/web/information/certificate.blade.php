...
<div id='sub_wrap'>
    ...
    <div class='cont_title'>
        <strong>중고차 거래의 새로운 방법<span>카검사 인증서</span></strong>
    </div>
    <div class='br30'></div>
    <ul class='intro2_wrap'>
        <li>
            ...
            <div class='para_type1'>
                ...
                카검사인증서는 현재와 같이 중고차 가격결정을 매매사업자가 주도적으로 결정하는 것이 아니라, 자동차관리법에 의거 법적권한을 가진 자동차기술사가 중고차가격산정조사를 통해 객관적 입장에서 공정하게 산출하여 공인합니다. 이를 통해 중고차 가치산정에 대한 객관성을 중고차 거래 시 보장받게 됩니다.
            </div><div class='br30'></div>
            <div class='para_type1'>
                <strong>중고차 거래를 원하시나요? 카검사인증서를 신청하세요!</strong>
                거래시 자동차의 정확한 성능과 공정한 가격을 원하면 카검사인증서를 요구하세요! 당신의 차량에 권장 거래가격을 얻는 방법에는 여러가지가 있지만, 카검사인증서는 차별회된 중고차 가치산정 서비스를 제공합니다.
            </div>
        </li>
        <li>
    ...
    <ul class='intro2_wrap'>
        <li>
            <div class='intro2_btm_box'><strong class='fcol_lightGreen'>01</strong>카검사인증서는 카검사만의 고유한 차량성능진단과 연도, 제조사, 모델, 주행거리, 위치 및 조건을 고려하여 차량식별번호(차대번호) 별로 고유하게 발급됩니다.</div>
            <div class='br30'></div>
        </li>
        <li>
