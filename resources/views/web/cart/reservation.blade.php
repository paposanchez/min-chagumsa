    ...
    <div id='sub_wrap'>
        ...
        <div class='join_wrap order-container'>
            ...
            <div class='order_info_box'>
                ...
                <div class='br10'></div>
                <div class='ipt_line'>
                    <input type="text" class="ipt wid20 in_date datepicker2" data-format="YYYY-MM-DD"
                           placeholder="{{ trans('web/order.reservation_date') }}" name='reservaton_date' value=''
            ...
            <div class='order_info_box'>
                ...
                <div class='ipt_line'>
                    <input type='text' id="garage_info" class='ipt wid40 dis' readonly
                           placeholder='지역을 검색하여 원하는 대리점을 선택하세요' autocomplete="off">
                </div>
                ...
                <div class='ipt_line'>
                    ...
                    &nbsp;&nbsp;<button class='btns btns_skyblue wid10' type="button" style='position:relative;'
                                        id="search">검색
                    </button>
                </div>
            ...
            <div class='ipt_line wid33'>
                <button class='btns btns_blue wid33' style='display:inline-block;'>이전</button>&nbsp;&nbsp;
                <button type="submit" class='btns btns_green wid33' style='display:inline-block;'>다음</button>
            </div>
