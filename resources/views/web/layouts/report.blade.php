...
@section( 'content-header' )
    <div id='report_wrap'>
        ...
        <div class='report_left'>
            ...
            <ul>
                <li><a class="{{ ( !in_array($page, ['performance','history','price'])) ? ' select': ''}}" href='{{ route('certificate', ['id'=>$order->id,'page'=>'summary']) }}'>자동차 요약 보고서</a></li>
                <li><a class="{{ $page == 'performance' ? ' select':''}}" href='{{ route('certificate', ['id'=>$order->id,'page'=>'performance']) }}'>자동차 품질 보고서</a></li>
                <li><a class="{{ $page == 'price' ? ' select':''}}" href='{{ route('certificate', ['id'=>$order->id,'page'=>'price']) }}'>자동차 가격 산정 보고서</a></li>
