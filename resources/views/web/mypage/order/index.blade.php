...
<div id='sub_wrap'>
    ...
    <div class='order_info_box'>
        ...
        <div class='order_info_cont'>
            ...
            @if($orders->status_cd == 102)
                <div class="label label-info">
            @elseif($orders->status_cd > 102)
               ...
               <!--  <ul>
                ...
                <li><small><span>주문일</span> {{ $orders->created_at }}</small></li>
                ...
                <!-- @if( $orders->status_cd < 105 && $orders->status_cd != 100 )
                    <button type="button" class="btn btn-default cancel-click" id="cancel" data-cancel_order_id="{{ $orders->id }}" style="display: block;">결제취소</button>
                @endif
 -->
