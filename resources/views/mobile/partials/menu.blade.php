...
{{--                            <a class='profile_setting' href="{{ url("/mypage/profile") }}"><i class="fa fa-cog"></i></a>--}}
                            <a class='profile_setting' href='javascript:alert("차검사 서비스 이용에 불편을 드려 죄송합니다.\nhttp://www.chagumsa.com [PC버전]을 이용해 주세요.");'><i class="fa fa-cog"></i></a>
                        </div>
                ...
                <ul class='menu_list'>
                    ...
                    <li><a class='menu3' href='javascript:alert("차검사 서비스 이용에 불편을 드려 죄송합니다.\nhttp://www.chagumsa.com [PC버전]을 이용해 주세요.");'>MY 인증서</a></li>
                    ...
                    <li><a class='sub_menu menu2' href="#">고객센터</a>
                        <div>
                            ...
                            <a href='javascript:alert("차검사 서비스 이용에 불편을 드려 죄송합니다.\nhttp://www.chagumsa.com [PC버전]을 이용해 주세요.");'>1:1 문의</a>
                        </div>
                    </li>
                </ul>
