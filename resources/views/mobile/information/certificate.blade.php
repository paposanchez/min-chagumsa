...
@section( 'content' )
    ...
    <div class='cont_title'>
        ...
        <strong>차검사 인증서는 <span>4개의 보고서로</span><br> 구성됩니다.</strong>
    </div>
    <div class='br20'></div>
    <ul class='intro2_wrap'>
        <li>
            <div class='intro2_btm_box'><strong class='fcol_lightGreen'><span>STEP</span>01</strong>[요약보고서] 전체 항목에 대해 간단히 보여주는 보고서입니다. 품질 등급과 산정 가격은 물론 종합진단 결과에서는 모든 영역에 대한 평가를 한 눈에 볼 수 있습니다.</div>
            <div class='br20'></div>
        </li>
        <li>
            <div class='intro2_btm_box'><strong class='fcol_lightGreen'><span>STEP</span>02</strong>[품질 보고서] 차량정보와 진단 결과를 자세히 볼 수 있습니다. 차량정보, 진단정보, 주요상태와 진단결과로 구성되어 있으며, 인증등급이 표시됩니다.</div>
            <div class='br20'></div>
        </li>
        <li>
            <div class='intro2_btm_box'><strong class='fcol_lightGreen'><span>STEP</span>03</strong>[가격 산정 보고서] 실제 거래 시 활용할 수 있는 보고서입니다. 차량정보와 가격산정내역이 상세히 표시되어 있으며, 해당 내용을 차검사가 인증합니다.</div><div class='br20'></div>
        </li>
        <li>
            <div class='intro2_btm_box'><strong class='fcol_lightGreen'><span>STEP</span>04</strong>[이력 보고서] 차량의 이력을 보여줍니다. 연식과 주행거리 등의 기본 정보부터 보험사고, 소유자, 정비, 용도 변경 등의 상세 정보까지 기록됩니다.
            </div>
        </li>
    </ul>
