...
@section( 'content' )
    ...
    <div class="menu-tab-box">
        <ul class='menu_tab_wrap'>
            ...
            <li><a href="#" class="select">제 값 받기 힘든 내 차 가격</a></li>
        </ul>
    </div>
        ...
        <div class="contents-inner">
            <div class="contents-title-box">
                ...
                <div class="contents-writer">
                    ...
                    {{-- SNS --}}
                    @include('mobile.partials.sns', ['link' =>  url('information/guide')])
                </div>
            </div>

            <div class="contents-sample-box">
                <p class="img">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0301.png")) }}</p>
            ...
            <div class="contents-description-box">
                ...
                <div class="thumb-box2">
                    ...
                    <ul>
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0302.jpg"), "매매단지 3,350만원") }}</p>
                        </li>
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0303.jpg"), "A딜러 3,400만원") }}</p>
                        </li>
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0304.jpg"), "B딜러 3,000만원") }}</p>
                        </li>
                    </ul>
                </div>

                <p>정부는 중고차 시장의 투명성 확보와 소비자 보호를 위해 중고차 가격 조사 산정제도를 작년부터 시행하고 있습니다. 중고차가격조사산정제도란 중고차 거래 시 중고차의 성능 및 상태 등 품질을 근거로 법적 자격을 갖춘 제3의 객관적 주체(기술사)로부터 공정한 중고차 가격을 산정하는  제도입니다.</p>
