    ...
    <div id='sub_wrap' class="wht">
        <div class="contents-inner">
            <div class="contents-title-box">
                <p>[차검사이야기] 구매할 때 성능기록부와 실제 상태가 달라요.</p>
            ...
            <div class="contents-description-box">
                <p>지난 해 중고차 거래는 380만 대로 신차 거래167만 대의 2배를 훌쩍 넘어섰습니다. 중고차 거래액은 30조 원으로 앞으로 2배 이상 늘어날 것으로 예측하고 있습니다. 신차 가격은 큰 폭으로 오르는 반면 가계 부채가 늘어 구매력이 낮아진 소비자들이 중고차에 관심을 갖는 것입니다.</p>

                <h3>늘어나는 소비자 사례</h3>
                <p>중고차 시장이 크게 성장한 만큼 중고차 관련 소비자 피해도 급증하고 있습니다. 허위매물은 물론 성능기록, 주행거리 조작 등은 매년 사회적 문제로 대두되고 있는 대표적 피해 사례입니다. 한국소비자원이 접수한 2013~2014년 중고자동차 매매 관련 소비자 피해는 총 843건 입니다. 이 중 중고차 성능 점검 내용과 실제차량의 상태가 다른 경우가 651건(77.2%)으로 가장 많았습니다.</p>
                <p>세부적으로는 '성능 및 상태 불량'이 333건(51.2%)으로 가장 많았고, 사고정보 고지 미흡 180건(27.6%), 주행거리 조작 68건(10.4%), 연식 및 모델이 다른 경우 39건(6%), 침수차량 미고지 31거(4.8%) 순으로 나타났습니다.</p>
