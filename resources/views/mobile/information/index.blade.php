...
@section( 'content' )
    ...
    <div class="menu-tab-box">
        <ul class='menu_tab_wrap'>
            <li><a class='select' href="#">중고차 성능기록과 실제 차이</a></li>
            <li><a href="{{ url("/information/price") }}">보증 기간 만료와 수리비 폭탄</a></li>
        ...
        <div class="contents-inner">
            <div class="contents-title-box">
                ...
                <div class="contents-writer">
                    ...
                    {{-- SNS --}}
                    @include('mobile.partials.sns', ['link' =>  url('information/index')])
                </div>
            </div>

            <div class="contents-sample-box">
                <p class="img">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0101.png")) }}</p>
            ...
            <div class="contents-description-box">
                ...
                <h3>늘어나는 소비자 사례</h3>
                <p>중고차 시장이 크게 성장한 만큼 중고차 관련 소비자 피해도 급증하고 있습니다. 허위매물은 물론 성능기록, 주행거리 조작 등은 매년 사회적 문제로 대두되고 있는 대표적 피해 사례입니다. 한국소비자원이 접수한 2013~2014년 중고자동차 매매 관련 소비자 피해는 총 843건입니다. 이 중 중고차 성능 점검 내용과 실제 차량의 상태가 다른 경우가 651건(77.2%)으로 가장 많았습니다.</p>
                <p>세부적으로는 '성능 및 상태 불량'이 333건(51.2%)으로 가장 많았고, 사고 정보 고지 미흡 180건(27.6%), 주행거리 조작 68건(10.4%), 연식 및 모델이 다른 경우 39건(6%), 침수차량 미고지 31거(4.8%) 순으로 나타났습니다.</p>

                <div class="figure-box">
                    <h4>중고차 매매 관련 소비자 피해</h4>
                    <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0102.jpg"), "중고차 매매 관련 소비자 피해 그래프") }}</p>
                </div>
                ...
                <div class="thumb-box">
                    <ul>
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0103.jpg")) }}</p>
                            <dl>
                                <dt>주행거리 조작</dt>
                        ...
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0104.jpg")) }}</p>
                            <dl>
                                <dt>차량 성능사기</dt>
                        ...
                        <li>
                            <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/sample0105.jpg")) }}</p>
                            <dl>
                                <dt>피해보상 책임 회피</dt>
                ...
                <p>물론 성실하고 믿을 수 있는 중고자 동차 매매업자도 많을 테지만, 피해사례가 급증하고 있는 만큼 주의가 필요합니다. 중고차동차 매매상에 대한 불신이 커지면서 개인간 직거래도 증가하고 있습니다. 하지만 개인간 직거래 또한 성능 불량 등 품질의 위험성과 합리적 가격 책정의 어려움, 거래 후 발생하는 문제에 대한 법적인 보호를 받기 힘든 만큼 소비자 개인이 조금 더 꼼꼼히 따져보고 준비해야 피해를 최소화 할 수 있습니다.</p>
