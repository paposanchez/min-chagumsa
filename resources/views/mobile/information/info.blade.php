    ...
    <div id='sub_wrap' class="gray">
        ...
        <div class="sub-contents-block wht" id="anc02">
            <div class="contents-inner inpadding">
                ...
                <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0101.jpg")) }}</p>
                <ul class="service-anc02">
                    <li>
                        <dl>
                            <dt>엄격한 정밀 진단</dt>
                            <dd>세계 최대 차량 진단 네트워크 보쉬카서비스가 진단합니다.</dd>
                        </dl>
                    </li>
                    <li>
                        <dl>
                            <dt>공인된 가격 산정</dt>
                            <dd>법적 권한을 가진 전문가가 직접 등급 및 가격을 책정합니다.</dd>
                        </dl>
                    </li>
                    <li>
                        <dl>
                            <dt>인증서, 보증서 발급</dt>
                            <dd>인증서, 보증서 발급 이후 6개월 동안 보증합니다.</dd>
                        </dl>
                    </li>
                </ul>
            </div>
        ...
        <div class="sub-contents-block" id="anc03">
            <div class="contents-inner">
                ...
                <div class="service-anc03-box">
                    ...
                    <p class="thumb">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0102.jpg")) }}</p>
                    <ul>
                        <li>
                            <dl>
                                <dt>엔진(13개)</dt>
                ...
                <div class="service-anc06-box">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="block">
                                <span>사고차량</span>
                                <p class="ico01">진단 오류에 대해 감가금액을 보상 지급합니다.</p>
                            </div>
                            <div class="block">
                                <span>침수차량</span>
                                <p class="ico02">오류에 대해 차량가치산정 금액으로 매입합니다.</p>
                            </div>
                            <div class="block">
                                <span>기타 오류 진단</span>
                                <p class="ico03">해당 내용에 대해 수리 보상합니다.</p>
                            </div>
                        </li>
                        <li>
                            <h4>수리 보상 절차</h4>
                            ...
                            <div class="h4-box">
                                ...
                                <div class="table-box">
                                    <table>
                                        <caption>수리 보증 항목</caption>
                                        <colgroup>
                                            <col style="width:70px"><col style="width:*"><col style="width:*"><col style="width:*"><col style="width:*">
                                        </colgroup>
                                        <tbody>
                                        <tr>
                                            <th class="bg">수리<br> 네트워크</th>
                                            <td class="ac">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0104.jpg")) }}</td>
                                            <td class="ac">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0105.jpg")) }}</td>
                                            <td class="ac">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0106.jpg")) }}</td>
                                            <td class="ac">{{ Html::image(\App\Helpers\Helper::theme_mobile("/images/service0107.jpg")) }}</td>
                                        </tr>
                                        <tr>
                                            <th class="bg">수리<br> 가능 차량</th>
            ...
            <div class="contents-inner">
                ...
                <div class="table-box">
                    <table>
                        ...
                        <colgroup>
                            <col style="width:*"><col style="width:20%"><col style="width:30%"><col style="width:30%">
                        </colgroup>
                        <thead>
                        <tr>
                            <th>구분</th>
