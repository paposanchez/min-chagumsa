...
@if($entry['use_image'] == 1)
        ...
        @if($entry['use_image'] == 1)
        <form class="diagnosis-uploader-form pull-right " action="/diagnosis/upload-file" method="post" enctype="multipart/form-data" style="width:38px;height:38px;display:inline-block;margin-right:5px;">
                ...
                <div data-id="{{ $entry['id'] }}" class='btn btn-circle btn-icon btn-info diagnosis-uploader'><i  class="fa fa-upload"></i></div>
        </form>
        @endif
