        ...
        <dd class="document-information-basic">
                ...
                <table>
                        ...
                        <tr>
                                ...
                                <th>계약자이름</th>
                                <td>{{ $data->orderItem->order->orderer_name }}</td>
                        </tr>
                </table>
                @else
                <table>
                        ...
                        <tr>
                                ...
                                <th>주행거리(km)</th>
                                <td>{{ number_format($data->orderItem->order->mileage) }}km</td>
                                <th>사용연료</th>
