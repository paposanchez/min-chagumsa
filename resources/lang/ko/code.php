...
return [
    ...
    'diagnosis_state_group' => [
        ...
        'attachment_state_cd' => '차대번호 손상여부',
        'color_cd' => '색상진단코드',
        'repair_state_cd' => '수리진단코드',
        'history_state_cd' => '상태이력진단코드',
        ...
        'part_state_cd' => '교환진단코드',
        'accident_repair_state_cd' => '수리진단코드',
        'stink_state_cd' => '악취진단코드',
        'water_state_cd' => '수분오염진단코드',
        'dirt_state_cd' => '이물질진단코드',
        'scratch_state_cd' => '흠집진단코드',
        'noise_state_cd' => '소음진단코드',
        'grade_cd' => '등급코드',
        'noise_state_cd' => '소음진단코드',
        'operation_state_cd' => '동작진단코드',
        'leakage_state_cd' => '누유진단코드',
    ...
    'car_option_exterior' => [
        'HID' => '제논 헤드램프(HID)',
        'powered_side_mirror' => '전동접이 사이드미러',
        'sun_roof' => '선루프(순정)',
        'panorama_sun_roof' => '파노라마 선루프',
        'roof_back' => '루프백',
        'aluminum_wheel' => '알루미늄 휠'
    ],
    'car_option_multimedia' => [
        'cd_player' => 'CD플레이어',
        'cd_changer' => 'CD체인저',
        'av_system' => 'AV시스템(순정)',
        'rear_tv' => '뒷자석TV',
    ...
    'car_option_interior' => [
        ...
        'ecm' => 'ECM',
        'leather_sheet' => '가죽시트',
        'powered_seat_in_driver' => '전동시트(운전석)',
        'powered_seat_in_passenger' => '전동시트(조수석)',
        'hit_seat_in_front' => '열선시트(앞좌석)',
        'hit_seat_in_rear' => '열선시트(뒷자석)',
        'memory_seat' => '메모리시트',
        'ventilation_seat_in_front' => '통풍시트(앞좌석)'
    ],
    'car_option_safety' => [
        'airbag_in_driver' => '에어백(운전석)',
        'airbag_in_passenger' => '에어백(동승석)',
        'airbag_side' => '에어백(사이드)',
        'curtain_airbag' => '커튼에어백',
        'rear_sensor' => '후방감지센서',
        'rear_camera' => '후방카메라',
        'abs' => 'ABS',
        'tcs' => 'TCS(미끄럼방지)',
        'position_controller' => '차체자세 제어장치',
        'ecs' => 'ECS(전자제어 서스펜션)',
        'tpms' => 'TPMS(타이어 공기압감지)',
        'power_doorlock' => '파워도어록'
    ],
    'car_option_facilities' => [
        'auto_airconditioner' => '자동에어컨',
        'remote_door_lock' => '무선도어 잠금장치',
        'smart_key' => '스마트키',
        'power_trunk' => '파워트렁크',
        'power_window' => '파워윈도우',
    ...
    'diagnosis_check_immersion' => [
        ...
        'diagnosis_immersion_front_floor' => '앞좌석 실내바닥',
    ...
    'diagnosis_powermover_cooling_water' => [
        ...
        'diagnosis_cooling_water_cooling_water_state' => '냉각수량 및 오염'
    ],
    ...
    'diagnosis_transmission_auto_transmission' => [
        ...
        'diagnosis_auto_transmission_oil_state' => '오일유량 및 상태',
    ...
    'diagnosis_transmission_transmission' => [
        ...
        'diagnosis_transmission_oil_state' => '오일유량 및 상태',
    ...
    'diagnosis_braking' => [
        'diagnosis_braking_break_oil_state' => '브레이크 오일유량 상태',
