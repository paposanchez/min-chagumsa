    ...
    function processHTTP($url, $param) {
        ...
        $contextOptions = array(
            'ssl' => array(
                ...
                'verfy_host' => false,
//                'local_cert' => '/var/www/app/classes/Mixapply/Checkout/INIpay50/key/INIpayTest/mcert.pem',
//                'passphrase' => '1111',
//                'CN_match' => 'market.inven.co.kr', // Change this to your certificates Common Name (or just comment this line out if not needed)
...
//                'disable_compression' => true,
        ...
        $this->sock = stream_socket_client("ssl://$this->host:$this->port", $errno, $errstr, 20, STREAM_CLIENT_CONNECT, $context);
        if (!$this->sock) {
