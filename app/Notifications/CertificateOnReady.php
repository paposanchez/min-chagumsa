...
class CertificateOnReady extends Notification implements ShouldQueue
{
    ...
    protected $event = 'certificate.OnReady';
...
//        return $return;
    ...
    public function toLgSms($notifiable)
    {
        ...
        return (new SmsMessage)
            ...
            ->from('1833-6889')
            ->to([$certificate->technist->mobile]);
    }
