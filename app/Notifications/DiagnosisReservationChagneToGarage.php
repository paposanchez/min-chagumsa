...
class DiagnosisReservationChagneToGarage extends Notification implements ShouldQueue
{
    ...
    protected $diagnosis;
    protected $event = 'diagnosis.ChangeReservationToGarage';
