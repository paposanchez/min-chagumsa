...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('bcs.user.index', compact('entrys'));
    ...
    public function edit($id)
    {
        ...
        return view('bcs.user.edit', compact('user', 'roles', 'userRole', 'status_cd_list', 'garages', 'aliances', 'user_extras', 'garage_info'));
    }
