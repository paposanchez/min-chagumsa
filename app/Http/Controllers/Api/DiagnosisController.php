                ...
                public function upload(Request $request)
                {
                        try {
                                ...
                                $response = $uploader->receive($uploader_name, function ($file, $path_prefix, $path, $file_new_name) {
                                        ...
                                        //============= 이미지 리사이즈 엔 워터마크
                                        if(in_array($file->getClientOriginalExtension(), ['png', 'jpg', 'jpeg', 'gif'])) {
                                ...
                                if ($response['result']) {
                                        ...
                                        try {
                                                ...
                                                $s3 = Storage::disk('s3');
                                                $s3->put('/diagnosis' . $storage_file, file_get_contents($diagnosis_upload_prifix.$storage_file));
                                                $s3->put('/diagnosis' . $storage_file.'.thumbnail.jpg', file_get_contents($diagnosis_upload_prifix.$storage_file.'.thumbnail.jpg'));
