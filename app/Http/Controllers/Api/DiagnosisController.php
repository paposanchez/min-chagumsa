                        ...
                        try {
                                ...
                                if ($response['result']) {
                                        ...
                                        try {
                                                ...
                                                $s3 = Storage::disk('s3');
                                                $s->put('/diagnosis' . $storage_file, file_get_contents($diagnosis_upload_prifix.$storage_file));
                                                $s->put('/diagnosis' . $storage_file.'.thumbnail.jpg', file_get_contents($diagnosis_upload_prifix.$storage_file.'.thumbnail.jpg'));
