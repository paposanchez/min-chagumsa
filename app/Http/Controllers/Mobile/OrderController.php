...
//        return view('web.order.index', compact('items','garages', 'brands', 'exterior_option', 'interior_option', 'safety_option', 'facilities_option', 'multimedia_option', 'user', 'search_fields'));
        return view('mobile.order.index_2', compact('items','garages', 'brands', 'exterior_option', 'interior_option', 'safety_option', 'facilities_option', 'multimedia_option', 'user', 'search_fields'));
    }
...
//            $order_where->item_id =;
        ...
        return view('mobile.order.payment-result', compact('result', 'event', 'decMoid'));
    }
    ...
    public function complete(Request $request) {
        ...
        return view('mobile.order.complete', compact('order', 'error'));
    }
