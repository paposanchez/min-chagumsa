...
class OrderController extends Controller {
    ...
    public function show($id) {
        ...
        return view('mobile.mypage.order.show', compact('order', 'my_garage', 'features'));
    }
    ...
    public function editCar($order_id){
        ...
        return view('mobile.mypage.order.edit_car', compact('order', 'brands', 'features'));
    }
    ...
    public function editGarage($order_id){
        ...
        return view('mobile.mypage.order.edit_garage', compact('order', 'search_fields', 'garages', 'my_garage'));
    }
