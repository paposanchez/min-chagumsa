...
class BcsPostController extends Controller {
...
//        }
        ...
        return view('admin.bcs-post.index', compact('entrys', 'board_list', 'shown_role_list', 'yn_list', 'request', 'search_fields'));
    }
    ...
    public function create() {
        ...
        return view('admin.bcs-post.create', compact('board_list', 'shown_role_list', 'yn_list', 'categorys'));
    }
...
//        $yn_list = Code::getCodesByGroup('yn');
        ...
        return view('admin.bcs-post.edit', compact('post', 'board_list', 'shown_role_list', 'yn_list', 'categorys'));
    }
